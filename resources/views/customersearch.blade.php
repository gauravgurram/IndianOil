...
@section('content')
      ...
      <div class="container-fluid" >
        <div class="container-fluid">
            <div class="container">
                <label for="exampleInputEmail1" class="form-label">सिलेक्ट - कस्टमरचे नाव</label>
                ...
                <a href="bill" id="recipt" target="_blank" class="btn btn-success closebtn" >प्रिंट बिल </a>
                        ...
                        <div class="card-body p-4">
                          <div class="table-responsive">
                            ...
                            <table class="table text-nowrap mb-0 align-middle"  >
                                ...
                                <tr>
                                    <th class="border-bottom-0">रक्कम </th>
                                ...
                                <tr>
                                    <th class="border-bottom-0">एकूण </th>
                                    <td id="completeamt"></td>
                                </tr>
                                <tr>
                                    <th class="border-bottom-0">जमा </th>
                                    <td id="advanceamt"></td>
                                </tr>
                                <tr>
                                    <th class="border-bottom-0">येणे रक्कम </th>
                                    <td id="pendingamt"></td>
                                </tr>

                                <tr>
                                    <th class="border-bottom-0">जमा टाक्या </th>
                                    <td id="tanksremaining"></td>
                                </tr>

                                <tr>
                                    <th class="border-bottom-0">टाक्या घेतले </th>
                                    <td id="tanksreturn"></td>
                                </tr>
                            </table>
                    ...
                    $(document).ready(function(){
                        $('select').on('change',function(){
                            ...
                            $.ajax({
                                    ...
                                    var dynamicURL = '/bill/' + data[0].cid;

                                    $('#recipt').attr("href",dynamicURL) ;

                                    $("#customername").html("<h2 class='text-center'><b><u>"+data[0].customer_name+"</u></b></h2>");

                                     for(i=0; i<data.length; i++)
                                     {
                                      $("#tanksgiven").html(data[i].tanks_given_today);
                                        $("#tankprice").html(data[i].tanks_price_per);
                                        $("#todaystotal").html(data[i].todays_total);
                                        $("#previousamt").html(data[i].previous_total);
                                        $("#completeamt").html(data[i].total);
                                        $("#advanceamt").html(data[i].today_given_amt);
                                        $("#pendingamt").html("<b>"+data[i].total+"</b>");
                                        $("#tanksremaining").html(data[i].tanks_remaining);
                                        $("#tanksreturn").html(data[i].tanks_return_today);
                                    }
                                    },
                                    error:function(data)
                                    {

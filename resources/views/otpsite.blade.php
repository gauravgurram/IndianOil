            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form method="get" action="{{ url('changepassword') }}">
                    @csrf
                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">OTP एंटर करा</label>
                    <input type="number" name="otp" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                  </div>
                  <button type="submit" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">नेक्स्ट</button>

...
<img class="rounded mx-auto  " src="{{ asset('backend/assets/images/logos/titleimg.png')}}" width="270" alt="" /><br><br>
...
@else
<div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Status:</span> <span class="badge badge-warning badge-pill px-25" id="unpaid">Unpaid</span></div>
@endif
</div>
</div>
</div>
...
<div class="row my-2">
    <div class="col-7 text-right">
        ...
        <div class="col-5">
            <span class="text-110 text-secondary-d1"><h5 class="text-danger" ><span id="prevtag"> ₹ {{ $previousamt}} /-</span></h5></span>
    </div>
</div>
<hr>
<div class="row my-2">
    <div class="col-7 text-right">
        ...
        <div class="col-5">
            <span class="text-110 text-secondary-d1"><h4 class="text-success" ><span id="prevtag"> ₹ {{ $completetotal}} /-</span></h4></span>
    </div>
</div>
...
<script>
    function printDiv(divName)
    {
        ...
        //     'invoiceno'=>$custid,
        //     'date'=>$today,
        //     'tankgiventoday'=>$tankgiventoday,
        //     'tankreturntoday'=>$tankreturntoday,
